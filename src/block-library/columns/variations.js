...
import { COLUMN_SELECTOR, COLUMN_NAME } from '../column/utils';
...
export const variations = [
	...
	},
	{
		...
		innerBlocks: [ getColumnState( 33.33 ), getColumnState( 66.66 ) ],
		scope: [ 'block' ],
	},
	{
		...
		innerBlocks: [ getColumnState( 66.66 ), getColumnState( 33.33 ) ],
		scope: [ 'block' ],
	},
	{
